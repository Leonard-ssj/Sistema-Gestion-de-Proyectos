      ...
      <div className="flex flex-col gap-2">
        {isLoading ? (
          ...
          items.map((n) => {
            ...
            const link = n.link ? n.link.replace("/app/tasks/", "/work/my-tasks/") : undefined
              ...
              >
                <CardContent className="flex items-start gap-3 p-4">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    {!n.read && (
                      <Button variant="ghost" size="sm" onClick={() => markRead(n.id)} className="text-xs">Leida</Button>
                    )}
                    {link && (
                      <Link href={link}><Button variant="outline" size="sm" className="text-xs">Ver</Button></Link>
                    )}
                    <Button
                      variant="ghost"
                      size="icon"
