...
export function AnimeDrawSvg({ className }: { className?: string }) {
  ...
  useEffect(() => {
    ...
    try {
      // Usamos el Proxy mágico de animejs v4 para exponer la propiedad "draw" en los SVG
  ...
  return (
    <div ref={containerRef} className={className}>
      <svg viewBox="0 0 304 112" className="w-full h-full text-primary drop-shadow-md">
